...
{
    public async Task IngestDataAsync(DirectoryInfo directory, string searchPattern, string sessionId = "System")
    {
        var collectionName = sessionId == "System" ? IngestedChunk.CollectionName : $"{IngestedChunk.CollectionName}_{sessionId}";
